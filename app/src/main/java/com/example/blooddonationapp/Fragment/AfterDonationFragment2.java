...
public class AfterDonationFragment2 extends Fragment implements View.OnClickListener {

    private AppCompatImageView mBack;
    private AppCompatImageView mClose;
    private Toolbar mToolbar;

    public AfterDonationFragment2() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_after_donation2, container, false);
    }
