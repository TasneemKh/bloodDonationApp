...
public class MapsActivity extends Fragment
    ...
    private static final String TAG1="MapsAvtivity";
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            if (locationList.size() > 0) {
                ...
                if(latitude != null && longitude != null ) {
                    FirebaseDatabase.getInstance().getReference().child("UserLocation").child(uid).setValue(data)
                            .addOnFailureListener(new OnFailureListener() {
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(getActivity().getApplicationContext(), "on Failuer", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(getActivity().getApplicationContext(), "please , open your gps", Toast.LENGTH_SHORT).show();
